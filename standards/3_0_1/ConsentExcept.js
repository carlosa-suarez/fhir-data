...
class ConsentExcept extends BackboneElement {
	...
	set actor (new_value) {
		...
		this.__actor = Array.isArray(new_value) ? new_value.map(val => new ConsentExceptActor(val)) : [new ConsentExceptActor(new_value)];
	}
	...
	set data (new_value) {
		...
		this.__data = Array.isArray(new_value) ? new_value.map(val => new ConsentExceptData(val)) : [new ConsentExceptData(new_value)];
	}
