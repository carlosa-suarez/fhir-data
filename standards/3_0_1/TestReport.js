...
class TestReport extends DomainResource {
	...
	set participant (new_value) {
		...
		this.__participant = Array.isArray(new_value) ? new_value.map(val => new TestReportParticipant(val)) : [new TestReportParticipant(new_value)];
	}
	...
	set test (new_value) {
		...
		this.__test = Array.isArray(new_value) ? new_value.map(val => new TestReportTest(val)) : [new TestReportTest(new_value)];
	}
