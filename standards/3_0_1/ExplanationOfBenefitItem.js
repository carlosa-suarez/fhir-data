...
class ExplanationOfBenefitItem extends BackboneElement {
	...
	set modifier (new_value) {
		const CodeableConcept = require('./CodeableConcept');
		this.__modifier = Array.isArray(new_value) ? new_value.map(val => new CodeableConcept(val)) : [new CodeableConcept(new_value)];
	}
	...
	set programCode (new_value) {
		const CodeableConcept = require('./CodeableConcept');
		this.__programCode = Array.isArray(new_value) ? new_value.map(val => new CodeableConcept(val)) : [new CodeableConcept(new_value)];
	}
	...
	set subSite (new_value) {
		const CodeableConcept = require('./CodeableConcept');
		this.__subSite = Array.isArray(new_value) ? new_value.map(val => new CodeableConcept(val)) : [new CodeableConcept(new_value)];
	}
	...
	set adjudication (new_value) {
		...
		this.__adjudication = Array.isArray(new_value) ? new_value.map(val => new ExplanationOfBenefitItemAdjudication(val)) : [new ExplanationOfBenefitItemAdjudication(new_value)];
	}
	...
	set detail (new_value) {
		...
		this.__detail = Array.isArray(new_value) ? new_value.map(val => new ExplanationOfBenefitItemDetail(val)) : [new ExplanationOfBenefitItemDetail(new_value)];
	}
