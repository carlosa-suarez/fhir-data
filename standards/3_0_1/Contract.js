...
class Contract extends DomainResource {
	...
	set action (new_value) {
		const CodeableConcept = require('./CodeableConcept');
		this.__action = Array.isArray(new_value) ? new_value.map(val => new CodeableConcept(val)) : [new CodeableConcept(new_value)];
	}
	...
	set actionReason (new_value) {
		const CodeableConcept = require('./CodeableConcept');
		this.__actionReason = Array.isArray(new_value) ? new_value.map(val => new CodeableConcept(val)) : [new CodeableConcept(new_value)];
	}
	...
	set agent (new_value) {
		...
		this.__agent = Array.isArray(new_value) ? new_value.map(val => new ContractAgent(val)) : [new ContractAgent(new_value)];
	}
	...
	set signer (new_value) {
		...
		this.__signer = Array.isArray(new_value) ? new_value.map(val => new ContractSigner(val)) : [new ContractSigner(new_value)];
	}
	...
	set valuedItem (new_value) {
		...
		this.__valuedItem = Array.isArray(new_value) ? new_value.map(val => new ContractValuedItem(val)) : [new ContractValuedItem(new_value)];
	}
	...
	set term (new_value) {
		...
		this.__term = Array.isArray(new_value) ? new_value.map(val => new ContractTerm(val)) : [new ContractTerm(new_value)];
	}
	...
	set friendly (new_value) {
		...
		this.__friendly = Array.isArray(new_value) ? new_value.map(val => new ContractFriendly(val)) : [new ContractFriendly(new_value)];
	}
	...
	set legal (new_value) {
		...
		this.__legal = Array.isArray(new_value) ? new_value.map(val => new ContractLegal(val)) : [new ContractLegal(new_value)];
	}
	...
	set rule (new_value) {
		...
		this.__rule = Array.isArray(new_value) ? new_value.map(val => new ContractRule(val)) : [new ContractRule(new_value)];
	}
