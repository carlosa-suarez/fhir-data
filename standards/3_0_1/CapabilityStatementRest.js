...
class CapabilityStatementRest extends BackboneElement {
	...
	set resource (new_value) {
		...
		this.__resource = Array.isArray(new_value) ? new_value.map(val => new CapabilityStatementRestResource(val)) : [new CapabilityStatementRestResource(new_value)];
	}
	...
	set interaction (new_value) {
		...
		this.__interaction = Array.isArray(new_value) ? new_value.map(val => new CapabilityStatementRestInteraction(val)) : [new CapabilityStatementRestInteraction(new_value)];
	}
	...
	set operation (new_value) {
		...
		this.__operation = Array.isArray(new_value) ? new_value.map(val => new CapabilityStatementRestOperation(val)) : [new CapabilityStatementRestOperation(new_value)];
	}
