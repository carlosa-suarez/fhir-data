...
class Procedure extends DomainResource {
	...
	set performer (new_value) {
		...
		this.__performer = Array.isArray(new_value) ? new_value.map(val => new ProcedurePerformer(val)) : [new ProcedurePerformer(new_value)];
	}
	...
	set complication (new_value) {
		const CodeableConcept = require('./CodeableConcept');
		this.__complication = Array.isArray(new_value) ? new_value.map(val => new CodeableConcept(val)) : [new CodeableConcept(new_value)];
	}
	...
	set complicationDetail (new_value) {
		const Reference = require('./Reference');
		this.__complicationDetail = Array.isArray(new_value) ? new_value.map(val => new Reference(val)) : [new Reference(new_value)];
	}
	...
	set followUp (new_value) {
		const CodeableConcept = require('./CodeableConcept');
		this.__followUp = Array.isArray(new_value) ? new_value.map(val => new CodeableConcept(val)) : [new CodeableConcept(new_value)];
	}
	...
	set focalDevice (new_value) {
		...
		this.__focalDevice = Array.isArray(new_value) ? new_value.map(val => new ProcedureFocalDevice(val)) : [new ProcedureFocalDevice(new_value)];
	}
	...
	set usedReference (new_value) {
		const Reference = require('./Reference');
		this.__usedReference = Array.isArray(new_value) ? new_value.map(val => new Reference(val)) : [new Reference(new_value)];
	}
	...
	set usedCode (new_value) {
		const CodeableConcept = require('./CodeableConcept');
		this.__usedCode = Array.isArray(new_value) ? new_value.map(val => new CodeableConcept(val)) : [new CodeableConcept(new_value)];
	}
