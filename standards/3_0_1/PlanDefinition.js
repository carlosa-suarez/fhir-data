...
class PlanDefinition extends DomainResource {
	...
	set goal (new_value) {
		...
		this.__goal = Array.isArray(new_value) ? new_value.map(val => new PlanDefinitionGoal(val)) : [new PlanDefinitionGoal(new_value)];
	}
	...
	set action (new_value) {
		...
		this.__action = Array.isArray(new_value) ? new_value.map(val => new PlanDefinitionAction(val)) : [new PlanDefinitionAction(new_value)];
	}
