...
class Provenance extends DomainResource {
	...
	set agent (new_value) {
		...
		this.__agent = Array.isArray(new_value) ? new_value.map(val => new ProvenanceAgent(val)) : [new ProvenanceAgent(new_value)];
	}
	...
	set entity (new_value) {
		...
		this.__entity = Array.isArray(new_value) ? new_value.map(val => new ProvenanceEntity(val)) : [new ProvenanceEntity(new_value)];
	}
