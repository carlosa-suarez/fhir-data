...
class StructureMapGroup extends BackboneElement {
	...
	set input (new_value) {
		...
		this.__input = Array.isArray(new_value) ? new_value.map(val => new StructureMapGroupInput(val)) : [new StructureMapGroupInput(new_value)];
	}
	...
	set rule (new_value) {
		...
		this.__rule = Array.isArray(new_value) ? new_value.map(val => new StructureMapGroupRule(val)) : [new StructureMapGroupRule(new_value)];
	}
