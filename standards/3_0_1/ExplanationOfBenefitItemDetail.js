...
class ExplanationOfBenefitItemDetail extends BackboneElement {
	...
	constructor ( opt ) {
		super( opt );
		this.__resourceType = 'ExplanationOfBenefitItemDetail';
		Object.assign(this, opt);
	}

	// This is a ExplanationOfBenefitItemDetail resource
	...
	set subDetail (new_value) {
		const ExplanationOfBenefitItemDetailSubDetail = require('./ExplanationOfBenefitItemDetailSubDetail');
		this.__subDetail = Array.isArray(new_value) ? new_value.map(val => new ExplanationOfBenefitItemDetailSubDetail(val)) : [new ExplanationOfBenefitItemDetailSubDetail(new_value)];
	}
...
module.exports = ExplanationOfBenefitItemDetail;
