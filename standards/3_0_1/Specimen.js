...
class Specimen extends DomainResource {
	...
	set processing (new_value) {
		...
		this.__processing = Array.isArray(new_value) ? new_value.map(val => new SpecimenProcessing(val)) : [new SpecimenProcessing(new_value)];
	}
	...
	set container (new_value) {
		...
		this.__container = Array.isArray(new_value) ? new_value.map(val => new SpecimenContainer(val)) : [new SpecimenContainer(new_value)];
	}
