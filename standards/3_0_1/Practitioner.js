...
class Practitioner extends DomainResource {
	...
	set qualification (new_value) {
		...
		this.__qualification = Array.isArray(new_value) ? new_value.map(val => new PractitionerQualification(val)) : [new PractitionerQualification(new_value)];
	}
	...
	set communication (new_value) {
		...
		this.__communication = Array.isArray(new_value) ? new_value.map(val => new CodeableConcept(val)) : [new CodeableConcept(new_value)];
	}
