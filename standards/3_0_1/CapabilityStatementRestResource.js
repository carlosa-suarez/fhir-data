...
class CapabilityStatementRestResource extends BackboneElement {
	...
	set interaction (new_value) {
		...
		this.__interaction = Array.isArray(new_value) ? new_value.map(val => new CapabilityStatementRestResourceInteraction(val)) : [new CapabilityStatementRestResourceInteraction(new_value)];
	}
	...
	set searchParam (new_value) {
		...
		this.__searchParam = Array.isArray(new_value) ? new_value.map(val => new CapabilityStatementRestResourceSearchParam(val)) : [new CapabilityStatementRestResourceSearchParam(new_value)];
	}
