...
class ValueSetComposeIncludeConcept extends BackboneElement {
	...
	set designation (new_value) {
		...
		this.__designation = Array.isArray(new_value) ? new_value.map(val => new ValueSetComposeIncludeConceptDesignation(val)) : [new ValueSetComposeIncludeConceptDesignation(new_value)];
	}
