...
class RequestGroupAction extends BackboneElement {
	...
	set condition (new_value) {
		...
		this.__condition = Array.isArray(new_value) ? new_value.map(val => new RequestGroupActionCondition(val)) : [new RequestGroupActionCondition(new_value)];
	}
	...
	set relatedAction (new_value) {
		...
		this.__relatedAction = Array.isArray(new_value) ? new_value.map(val => new RequestGroupActionRelatedAction(val)) : [new RequestGroupActionRelatedAction(new_value)];
	}
	...
	set participant (new_value) {
		...
		this.__participant = Array.isArray(new_value) ? new_value.map(val => new Reference(val)) : [new Reference(new_value)];
	}
