...
class Claim extends DomainResource {
	...
	set related (new_value) {
		...
		this.__related = Array.isArray(new_value) ? new_value.map(val => new ClaimRelated(val)) : [new ClaimRelated(new_value)];
	}
	...
	set careTeam (new_value) {
		...
		this.__careTeam = Array.isArray(new_value) ? new_value.map(val => new ClaimCareTeam(val)) : [new ClaimCareTeam(new_value)];
	}
	...
	set information (new_value) {
		...
		this.__information = Array.isArray(new_value) ? new_value.map(val => new ClaimInformation(val)) : [new ClaimInformation(new_value)];
	}
	...
	set diagnosis (new_value) {
		...
		this.__diagnosis = Array.isArray(new_value) ? new_value.map(val => new ClaimDiagnosis(val)) : [new ClaimDiagnosis(new_value)];
	}
	...
	set procedure (new_value) {
		...
		this.__procedure = Array.isArray(new_value) ? new_value.map(val => new ClaimProcedure(val)) : [new ClaimProcedure(new_value)];
	}
	...
	set insurance (new_value) {
		...
		this.__insurance = Array.isArray(new_value) ? new_value.map(val => new ClaimInsurance(val)) : [new ClaimInsurance(new_value)];
	}
