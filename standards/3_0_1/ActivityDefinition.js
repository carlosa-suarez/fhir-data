...
class ActivityDefinition extends DomainResource {
	...
	set participant (new_value) {
		...
		this.__participant = Array.isArray(new_value) ? new_value.map(val => new ActivityDefinitionParticipant(val)) : [new ActivityDefinitionParticipant(new_value)];
	}
	...
	set dynamicValue (new_value) {
		...
		this.__dynamicValue = Array.isArray(new_value) ? new_value.map(val => new ActivityDefinitionDynamicValue(val)) : [new ActivityDefinitionDynamicValue(new_value)];
	}
