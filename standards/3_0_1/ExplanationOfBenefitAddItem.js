...
class ExplanationOfBenefitAddItem extends BackboneElement {
	...
	constructor ( opt ) {
		super( opt );
		this.__resourceType = 'ExplanationOfBenefitAddItem';
		Object.assign(this, opt);
	}

	// This is a ExplanationOfBenefitAddItem resource
	...
	set detail (new_value) {
		const ExplanationOfBenefitAddItemDetail = require('./ExplanationOfBenefitAddItemDetail');
		this.__detail = Array.isArray(new_value) ? new_value.map(val => new ExplanationOfBenefitAddItemDetail(val)) : [new ExplanationOfBenefitAddItemDetail(new_value)];
	}
