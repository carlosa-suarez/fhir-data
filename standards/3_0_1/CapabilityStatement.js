...
class CapabilityStatement extends DomainResource {
	...
	set rest (new_value) {
		...
		this.__rest = Array.isArray(new_value) ? new_value.map(val => new CapabilityStatementRest(val)) : [new CapabilityStatementRest(new_value)];
	}
	...
	set messaging (new_value) {
		...
		this.__messaging = Array.isArray(new_value) ? new_value.map(val => new CapabilityStatementMessaging(val)) : [new CapabilityStatementMessaging(new_value)];
	}
	...
	set document (new_value) {
		...
		this.__document = Array.isArray(new_value) ? new_value.map(val => new CapabilityStatementDocument(val)) : [new CapabilityStatementDocument(new_value)];
	}
