...
class ImplementationGuide extends DomainResource {
	...
	set dependency (new_value) {
		...
		this.__dependency = Array.isArray(new_value) ? new_value.map(val => new ImplementationGuideDependency(val)) : [new ImplementationGuideDependency(new_value)];
	}
	...
	set package (new_value) {
		...
		this.__package = Array.isArray(new_value) ? new_value.map(val => new ImplementationGuidePackage(val)) : [new ImplementationGuidePackage(new_value)];
	}
	...
	set global (new_value) {
		...
		this.__global = Array.isArray(new_value) ? new_value.map(val => new ImplementationGuideGlobal(val)) : [new ImplementationGuideGlobal(new_value)];
	}
