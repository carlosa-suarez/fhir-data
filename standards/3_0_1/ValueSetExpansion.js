...
class ValueSetExpansion extends BackboneElement {
	...
	set parameter (new_value) {
		...
		this.__parameter = Array.isArray(new_value) ? new_value.map(val => new ValueSetExpansionParameter(val)) : [new ValueSetExpansionParameter(new_value)];
	}
	...
	set contains (new_value) {
		...
		this.__contains = Array.isArray(new_value) ? new_value.map(val => new ValueSetExpansionContains(val)) : [new ValueSetExpansionContains(new_value)];
	}
