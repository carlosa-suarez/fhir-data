...
class ExplanationOfBenefitBenefitBalance extends BackboneElement {
	...
	constructor ( opt ) {
		super( opt );
		this.__resourceType = 'ExplanationOfBenefitBenefitBalance';
		Object.assign(this, opt);
	}

	// This is a ExplanationOfBenefitBenefitBalance resource
	...
	set financial (new_value) {
		const ExplanationOfBenefitBenefitBalanceFinancial = require('./ExplanationOfBenefitBenefitBalanceFinancial');
		this.__financial = Array.isArray(new_value) ? new_value.map(val => new ExplanationOfBenefitBenefitBalanceFinancial(val)) : [new ExplanationOfBenefitBenefitBalanceFinancial(new_value)];
	}
