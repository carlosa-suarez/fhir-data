...
class Observation extends DomainResource {
	...
	set referenceRange (new_value) {
		...
		this.__referenceRange = Array.isArray(new_value) ? new_value.map(val => new ObservationReferenceRange(val)) : [new ObservationReferenceRange(new_value)];
	}
	...
	set related (new_value) {
		...
		this.__related = Array.isArray(new_value) ? new_value.map(val => new ObservationRelated(val)) : [new ObservationRelated(new_value)];
	}
	...
	set component (new_value) {
		...
		this.__component = Array.isArray(new_value) ? new_value.map(val => new ObservationComponent(val)) : [new ObservationComponent(new_value)];
	}
