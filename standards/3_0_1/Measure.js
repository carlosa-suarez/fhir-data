...
class Measure extends DomainResource {
	...
	set group (new_value) {
		...
		this.__group = Array.isArray(new_value) ? new_value.map(val => new MeasureGroup(val)) : [new MeasureGroup(new_value)];
	}
	...
	set supplementalData (new_value) {
		...
		this.__supplementalData = Array.isArray(new_value) ? new_value.map(val => new MeasureSupplementalData(val)) : [new MeasureSupplementalData(new_value)];
	}
