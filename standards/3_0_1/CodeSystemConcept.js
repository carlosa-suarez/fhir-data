...
class CodeSystemConcept extends BackboneElement {
	...
	set designation (new_value) {
		...
		this.__designation = Array.isArray(new_value) ? new_value.map(val => new CodeSystemConceptDesignation(val)) : [new CodeSystemConceptDesignation(new_value)];
	}
	...
	set property (new_value) {
		...
		this.__property = Array.isArray(new_value) ? new_value.map(val => new CodeSystemConceptProperty(val)) : [new CodeSystemConceptProperty(new_value)];
	}
